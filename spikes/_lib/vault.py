"""Shared vault helpers for Phase 0 spike harnesses.
...
def write_transcript(path: Path, obj: dict) -> bool:
    """Persist a spike transcript as JSON. Returns True on success.
...
class Page:
    ...
    def sources(self) -> list[dict]:
        return self.frontmatter.get("sources") or []
...
if __name__ == "__main__":
    # Quick self-check: tree + lint every page. Doubles as the R-1.2
    # "script that checks the tree exists".
    import sys
